...
## Update (2026-03-20, ITAR scope dataset pipeline shipped)
- Added `/Users/carsonwang/CoatueClaw/src/coatue_claw/itar_scope.py`:
  - fetches annual GovInfo CFR snapshots for `22 CFR 121.1`.
  - counts deepest USML product-control entries year by year.
  - excludes notes, `[Reserved]`, technical-data/defense-service clauses, and interpretive branches.
...
- Current caveats:
  ...
  - Full-range smoke artifacts currently live in `/tmp/itar-scope-full` for inspection, not in git.
