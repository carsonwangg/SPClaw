...
## Board Seat - Simple Prompt Simplification (2026-02-27)
- Removed snippet-claim summaries from simple-mode LLM draft input.
- Funding lines in simple mode are generated by the LLM from fetched source text only.
- Defaults updated to 15 source links and no doc-char truncation cap.
