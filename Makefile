...
openclaw-board-seat-refresh-funding:
	/opt/coatue-claw/.venv/bin/python -m coatue_claw.board_seat_daily refresh-funding --all-portcos

openclaw-board-seat-funding-report:
	/opt/coatue-claw/.venv/bin/python -m coatue_claw.board_seat_daily funding-quality-report --all-portcos
